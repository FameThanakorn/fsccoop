...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', $_GET["w"] == 345 && $_GET["h"] == 215 ? '../images/common/default_345x215.jpg' : '../images/common/125x78/'.rand(1, 74).'.jpg');								// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', $_GET["w"] == 345 && $_GET["h"] == 215 ? '../images/common/default_345x215.jpg' : '../images/common/125x78/'.rand(1, 74).'.jpg');									// Image to serve if an error occurs instead of showing error message 
...
class timthumb {
	...
	public function __construct(){
		...
		$this->src = $this->getRealUrl($this->param('src'));
	...
	public function getRealUrl($photoLink) {
		$headers = @get_headers($photoLink, 1);
