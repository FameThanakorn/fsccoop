...
function transfer_cremation(id, action){
	...
	$.ajax({
		...
		success: function(msg) {
			...
			$(".cremation_no").val(response.cremation_no);
			$(".cremation_type_name").val(response.cremation_type_name);
			$(".cremation_approved_amount").val(response.cremation_approved_amount);
...
function edit_request_receive(cremation_request_id,member_id){
	...
	$.ajax({
		...
		success: function(msg) {
			...
			txt_file_attach += '</table>';
			$('#show_file_space').html(txt_file_attach);
			//console.log(response.cremation_receive_id);
