...
class Api extends CI_Controller {
	...
	{		
		...
		if(@$get_request_data['messageType'] == '0400' || @$get_request_data['messageType'] == '0420'){
			...
			$reversal = $this->reversal_refund(@$get_request_data['traceNo'],@$get_request_data['fromAcctType'],@$createdatetime);
			if($reversal == 0){
	...
	public function reversal_refund($trace_no,$from_acct_type,$createdatetime){		
