...
class Benefits extends CI_Controller {
	...
	function get_benefits_type(){
		...
		if($row["special_con_selected"] == "payment_receive") {
			...
			$row["conditions"]['conditions_text'] .= "<label class='g24-col-sm-5 control-label text-right'>";
			$row["conditions"]['conditions_text'] .= "ความสัมพันธ์";
			$row["conditions"]['conditions_text'] .= "</label>";
			$row["conditions"]['conditions_text'] .= "<div class='g24-col-sm-6'>";
			$row["conditions"]['conditions_text'] .= "<select name='relate' id='relate' class='form-control'>";
			$row["conditions"]['conditions_text'] .= "<option value='father'>บิดา</option>";
			$row["conditions"]['conditions_text'] .= "<option value='mother'>มารดา</option>";
			$row["conditions"]['conditions_text'] .= "<option value='child'>บุตร</option>";
			$row["conditions"]['conditions_text'] .= "<option value='partner'>คู่สมรส</option>";
	...
	function get_benefits_request(){
		...
		if($row["special_con_selected"] == "payment_receive") {
			...
			$row["conditions"]['conditions_text'] .= "<div class='g24-col-sm-6'>";
			$row["conditions"]['conditions_text'] .= "<select name='relate' id='relate' class='form-control'>";
			if($relate != "" && $relate == "father") {
				$row["conditions"]['conditions_text'] .= "<option value='father' selected>บิดา</option>";
			} else {
				$row["conditions"]['conditions_text'] .= "<option value='father'>บิดา</option>";
			}
			if($relate != "" && $relate == "mother") {
				$row["conditions"]['conditions_text'] .= "<option value='mother' selected>มารดา</option>";
			} else {
				$row["conditions"]['conditions_text'] .= "<option value='mother'>มารดา</option>";
			}
			if($relate != "" && $relate == "child") {
				$row["conditions"]['conditions_text'] .= "<option value='child' selected>บุตร</option>";
			} else {
				$row["conditions"]['conditions_text'] .= "<option value='child'>บุตร</option>";
			}
			if($relate != "" && $relate == "partner") {
				$row["conditions"]['conditions_text'] .= "<option value='partner' selected>คู่สมรส</option>";
			} else {
				$row["conditions"]['conditions_text'] .= "<option value='partner'>คู่สมรส</option>";
			}
			$row["conditions"]['conditions_text'] .= "</select>";
