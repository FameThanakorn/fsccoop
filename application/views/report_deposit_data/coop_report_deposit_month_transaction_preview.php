		...
		?>	
			<tr>
				...
				<td class="text-center">
						...
						<h3 class="title_view">รายงานการเปลี่ยนแปลงเงินฝากหักส่งรายเดือน</h3>
						<h3 class="title_view">
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_deposit_data/coop_report_deposit_month_transaction_excel'.$get_param); ?>">
		...
		<table class="table table-view-2 table-center">
			<thead>
				...
				<tr>
					...
					<th style="width: 100px;vertical-align: middle;">เลขบัญชี</th>
					<th style="width: 120px;vertical-align: middle;">ชื่อ-นามสกุล</th>
					<th style="width: 30px;vertical-align: middle;">เลขสมาชิก</th>
					<th style="width: 50px;vertical-align: middle;">เงินเดือน</th>
					<th style="width: 50px;vertical-align: middle;">ส่ง</th>
					<th style="width: 50px;vertical-align: middle;">เปลียนเป็น</th>
					<th style="vertical-align: middle;">หน่วย</th>
					<th style="width: 120px;vertical-align: middle;">ผู้ทำรายการ</th>
				</tr>
			</thead>
			<tbody>
			...
			?>
				<tr>
					...
					<td style="text-align: center;vertical-align: top;"><?php echo ($row['createdatetime'])?$this->center_function->ConvertToThaiDate($row['createdatetime'],1,0):"";?></td>
					...
					<td style="text-align: right;vertical-align: top;"><?php echo number_format($row['prev_total_amount'],2); ?></td>
					<td style="text-align: right;vertical-align: top;"><?php echo number_format($row['total_amount'],2); ?></td>
					<td style="text-align: left;vertical-align: top;"><?php echo $row["group_name"];?></td>
