...
header("Content-Disposition: attachment; filename=รายงานเงินฝากครบกำหนด.xls"); 
	...
	?>
				<table class="table table-bordered">
					<tr>
						...
						<tr>
							<th class="table_title" colspan="6">รายงานเงินฝากครบกำหนด <?php echo $type_name;?></th>
						</tr>
						<tr>
				...
				<table class="table table-bordered">
					<thead> 
						<tr>
							...
							<th class="table_header_top" style="vertical-align: middle;">วันที่ฝาก</th>
							...
							<th class="table_header_top" style="vertical-align: middle;">ประเภทบัญชี</th>
							<th class="table_header_top" style="vertical-align: middle;">ระยะเวลาฝาก</th>
							<th class="table_header_top" style="vertical-align: middle;">ยอดเงิน</th>
					...
					<tbody>
						...
						?>
							<tr> 
							  ...
							  <td class="table_body" style="text-align: center;vertical-align: top;"><?php echo $row['type_code'];?></td>
							  <td class="table_body" style="text-align: center;vertical-align: top;"><?php echo $row['interest_period'];?></td>
							  ...
							  <td class="table_body" style="text-align: right;vertical-align: top;"><?php echo number_format($row['transaction_deposit'] + $row['interest'],2);?></td>
							</tr>											
						...
						?>
							<tr>
								<td colspan="6" class="table_body" style="text-align: center;vertical-align: top;">
									รวม
								</td>
								<td class="table_body" style="text-align: center;vertical-align: top;">
								...
								<td class="table_body" style="text-align: center;vertical-align: top;">
									<?php echo number_format($total_deposit + $total_interest,2)?>
								</td>
							</tr>
					</tbody>    
				</table>
