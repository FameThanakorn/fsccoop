			...
			<div class="panel panel-body" style="padding-top:10px !important;min-height: 1200px;">
				...
				?>	
					<tr>
						...
						<td class="text-center">
							...
							<h3 class="title_view">รายงานดอกเบี้ยเงินฝากล่วงหน้าสมาชิก</h3>
				...
				if(!empty($master)){
					foreach($master as $key => $mas) { ?>
						<div class="title_view" style="text-align: left;">
							<?php echo $mas["type_code"]." ".$mas["type_name"]; ?><br>
							เลขที่บัญชี <?php echo $mas["account_id"]; ?> ชื่อบัญชี <?php echo $mas["account_name"]; ?>
						</div>
						...
						<table class="table table-view table-center">
							<thead> 
								<tr>
									...
									<th style="vertical-align: middle;">เดือน</th>
							...
							?>
									<tr> 
									  ...
									  <td style="text-align: center;vertical-align: top;"><?php echo $row['y'];?></td>
									  <td style="text-align: center;vertical-align: top;"><?php echo $row['m'];?></td>
							...
							<?php if(isset($total_deposit)) { ?>
								<tr style="font-weight: bold;">
									<td colspan="3" style="text-align: center;vertical-align: top;">รวม</td>
