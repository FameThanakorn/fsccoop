...
header("Content-Disposition: attachment; filename=รายงานความเคลื่อนไหวบัญชี.xls"); 
	...
	?>
				<table class="table table-bordered">
					<tr>
						...
						<tr>
							<th class="table_title" colspan="7">รายงานความเคลื่อนไหวบัญชี <?php echo $type_name;?></th>
						</tr>
						<tr>
				...
				<table class="table table-bordered">
					<thead> 
						<tr>
							...
							<th class="table_header_top" style="vertical-align: middle;">ฝาก</th>
							<th class="table_header_top" style="vertical-align: middle;">ถอน</th>
						</tr>  
					</thead>
					<tbody>
						<?php	
						...
						<?php	
									...
									$total_withdrawal += $row['transaction_withdrawal'];
								}
							}
						...
						?>
							<tr>
								<td colspan="5" class="table_body" style="text-align: center;vertical-align: top;">
									รวม
								</td>
