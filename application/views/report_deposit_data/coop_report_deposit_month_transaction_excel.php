...
header("Content-Disposition: attachment; filename=รายงานการเปลี่ยนแปลงเงินฝากหักส่งรายเดือน.xls"); 
	...
	<html>
		...
		<body>
			...
			<table class="table table-bordered">
				...
				<tr>
					<th class="table_title" colspan="10">รายงานการเปลี่ยนแปลงเงินฝากหักส่งรายเดือน<?php echo $type_name;?></th>
				</tr>
				<tr>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						<th class="table_header_top" colspan="10" style="text-align: left;">
					...
					<tr>
						...
						<th class="table_header_top" style="vertical-align: middle;">เปลียนเป็น</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="table_body" style="text-align: center;vertical-align: top;"><?php echo ($row['createdatetime'])?$this->center_function->ConvertToThaiDate($row['createdatetime'],1,0):"";?></td>
						...
						<td class="table_body" style="text-align: left;vertical-align: top;"><?php echo $row['name'];?></td>
						...
						<td class="table_body" style="text-align: right;vertical-align: top;"><?php echo number_format($row['prev_total_amount'],2); ?></td>
						<td class="table_body" style="text-align: right;vertical-align: top;"><?php echo number_format($row['total_amount'],2); ?></td>
						<td class="table_body" style="text-align: left;vertical-align: top;"><?php echo $row["group_name"];?></td>
