...
<?php } else { ?>
		...
		<div class="col-md-6 col-md-offset-3">
				<h1 class="text-center m-t-1 m-b-1"> <?php echo(!empty($id)) ? "แก้ไขรายการชำระเงิน" : "เพิ่มรายการชำระอื่นๆ " ; ?></h1>

				<form id='form_save' data-toggle="validator" novalidate="novalidate" action="<?php echo base_url(PROJECTPATH.'/setting_account_data/coop_account_receipt_save'); ?>" method="post">	
			<?php if (!empty($id)) { ?>
