...
header("Content-Disposition: attachment; filename=รายงานเก็บได้บางส่วน (แยกตามหน่วยงาน).xls"); 
	...
	?>
			<table class="table table-bordered">
				<tr>
					...
					<tr>
						<th class="table_title" colspan="13">รายงานเก็บได้บางส่วน (แยกตามหน่วยงาน)</th>
					</tr>
					<tr>
