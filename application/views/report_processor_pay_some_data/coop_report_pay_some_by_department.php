<style>
	...
	@page { size: landscape; margin: 20px 0px 0px 0px;}
</style>		
<?php
//class="page-break"
if(!empty($data)){
				...
				?>	
					<tr>
						...
						<td class="text-center">
							 ...
							 <h3 class="title_view">รายงานเก็บได้บางส่วน(แยกตามหน่วยงาน)</h3>
							 <h3 class="title_view">
						 ...
						 <td style="width:100px;vertical-align: top;" class="text-right">
							...
							?>
							<a class="no_print"  target="_blank" href="<?php echo base_url('/report_processor_pay_some_data/coop_report_pay_some_by_department_excel'.$get_param); ?>">
