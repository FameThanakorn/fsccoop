...
header("Content-Disposition: attachment; filename=รายงานเก็บได้บางส่วน (รายละเอียดรายบุคคล).xls"); 
	...
	?>
			<table class="table table-bordered">
				<tr>
					...
					<tr>
						<th class="table_title" colspan="19">รายงานเก็บได้บางส่วน (รายละเอียดรายบุคคล)</th>
					</tr>
					<tr>
			...
			<table class="table table-bordered">
				...
				?>
					...
					?>
							...
							<td class="table_body" style="text-align: right;"><?php echo number_format(@$row['OTHER'],2); ?></td>
					...
					?>
						<tr> 
							...
							<td class="table_body" style="text-align: right;"><?php echo number_format(@$total_data[$value_group['id']]['OTHER'],2); ?></td>
			...
			?>
					<tr class="foot-border"> 
						...
						<td class="table_body" style="text-align: right;"><?php echo number_format(@$total_all_data['OTHER'],2); ?></td>
