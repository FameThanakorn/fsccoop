...
header("Content-Disposition: attachment; filename=รายงานเก็บได้บางส่วน (สรุปรายบุคคล).xls"); 
	...
	?>
			<table class="table table-bordered">
				<tr>
					...
					<tr>
						<th class="table_title" colspan="9">รายงานเก็บได้บางส่วน (สรุปรายบุคคล)</th>
					</tr>
					<tr>
			...
			<table class="table table-bordered">
				...
				if(!empty($row_group)){
					...
					<tr class="foot-border"> 
						<td class="table_body" style="text-align: center;font-weight:bold;" colspan="5">รวมทั้งหมด :: <?php echo ($count_all_data == 0)?'-':number_format(@$count_all_data); ?> รายการ</td>
