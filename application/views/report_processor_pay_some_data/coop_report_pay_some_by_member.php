			...
			<div class="panel panel-body" style="padding-top:10px !important;min-height: 1000px;">
				...
				?>	
					<tr>
						...
						<td class="text-center">
							 ...
							 <h3 class="title_view">รายงานเก็บได้บางส่วน (สรุปรายบุคคล)</h3>
							 <h3 class="title_view">
						 ...
						 <td style="width:100px;vertical-align: top;" class="text-right">
							...
							?>
							<a class="no_print"  target="_blank" href="<?php echo base_url('/report_processor_data/coop_report_non_pay_by_member_excel'.$get_param); ?>">
				...
				<table class="table table-view table-center">
					...
					<?php									
							...
							$count_all_data += count($value_group['non_pay_data'][$i]);
					?>
							<tr> 
					...
					?>
							<tr class="foot-border"> 
								<td style="text-align: center;font-weight:bold;" colspan="5">รวมทั้งหมด :: <?php echo ($count_all_data == 0)?'-':number_format(@$count_all_data); ?> รายการ</td>
