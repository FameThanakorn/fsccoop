				...
				<div class="panel panel-body ">
                    ...
                    <form data-toggle="validator" method="post" action="<?php echo base_url(PROJECTPATH.'/compromise/run_compromise_return_process'); ?>" class="g24 form form-horizontal no_print" enctype="multipart/form-data" autocomplete="off" id="form_1">
                        ...
                        <div class="form-group g24-col-sm-24">
                            ...
                            <!-- <label class="g24-col-sm-2 text-right">กองทุน</label>
                            <div class="g24-col-sm-6">
                                <input id="fund_total" class="form-control g24-col-sm-18" type="text" value="<?php echo number_format($fund,2);?>" readonly>
                            </div> -->
                        </div>
                        <div class="form-group g24-col-sm-24">
                            ...
                            <div class="g24-col-sm-21">
                                <table class="table ">
                                    ...
                                    ?>
                                        <input type="hidden" id="refrain_loan_id_<?php echo $compromise["member_id"];?>" name="refrain_loan_id[<?php echo $compromise["member_id"];?>]" value="<?php echo $compromise['refrain_loan_id'];?>"/>
                                        <input type="hidden" id="interest_debt_<?php echo $compromise["member_id"];?>" name="interest_debt[<?php echo $compromise["member_id"];?>]" value="<?php echo $compromise['interest_data_raw'];?>"/>
                                        <tr>
                                            <td>
                                                <?php echo ++$index;?>
                                            </td>
                        ...
                        <div class="form-group g24-col-sm-24">
                            <label class="g24-col-sm-24 text-left"><h3>ต้องการชำระต่อ</h3></label>
                        </div>
                        <div class="form-group g24-col-sm-24">
                            <label class="g24-col-sm-3 text-right">เงินต้น</label>
                            <div class="g24-col-sm-5">
                                <input id="new_loan_amount_balance" name="new_loan_amount_balance" class="form-control g24-col-sm-22" type="text" value="<?php echo number_format($total_loan_amount_balance + $fund_balance,2);?>" onkeyup="format_the_number_decimal(this);">
                            </div>
                            <label class="g24-col-sm-3 text-right">ดอกเบี้ยค้างชำระ</label>
                            <div class="g24-col-sm-5">
                                <input id="new_loan_interest_debt" name="new_loan_interest_debt" class="form-control g24-col-sm-20" type="text" value="<?php echo empty($refrain_loan_id) ? number_format($interest_debt + $fund_interest_balance,2) : number_format($fund_interest_balance,2);?>" onkeyup="format_the_number_decimal(this);">
                            </div>
                            <label class="g24-col-sm-3 text-right">ค่าใช้จ่ายอื่นๆ</label>
                            <div class="g24-col-sm-5">
                                <input id="new_loan_other_debt" name="new_loan_other_debt" class="form-control g24-col-sm-20" type="text" value="<?php echo number_format($other_debt,2);?>" onkeyup="format_the_number_decimal(this);">
                            </div>
                        </div>
                        <div class="form-group g24-col-sm-24">
                            <label class="g24-col-sm-3 text-right">ประเภทสัญญา</label>
                            <div class="g24-col-sm-5">
                                <select id="new_loan_type" name="new_loan_type" class="form-control g24-col-sm-22">
