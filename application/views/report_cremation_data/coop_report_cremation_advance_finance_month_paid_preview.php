		...
		?>	
			<tr>
				...
				<td style="width:100px;vertical-align: top;" class="text-right">
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_cremation_data/coop_report_advance_finance_month_paid_excel'.$get_param); ?>">
		...
		<table class="table table-view table-center">
			<thead>
				...
				<tr>
					...
					<th style="vertical-align: middle; width:8%;">จํานวนเงิน</th>
				</tr>
			</thead>
			<tbody>
			...
			?>
				<tr>
					...
					<td class="text-right" style="vertical-align: middle;"><?php echo number_format($row["in_schedule_pay_amount"],2);?></td>
				</tr>
			<?php
			...
			?>
				<tr>
					<td colspan="3" class="text-center" style="vertical-align: middle;">รวม</td>
