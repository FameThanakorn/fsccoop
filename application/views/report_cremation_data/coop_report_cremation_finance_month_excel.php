...
header("Content-Disposition: attachment; filename=รายงานรายการเรียกเก็บ.xls"); 
...
?>
			<table class="table table-bordered">
				<tr>
					...
					<tr>
						<th class="table_title" colspan="9">รายงานรายการเรียกเก็บ<?php echo $type_name;?></th>
					</tr>
					<tr>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="table_header_top" style="vertical-align: middle;">คงค้าง</th>
					</tr>
				</thead>
				<tbody>
				<?php
				...
				?>
					<tr>
						...
						<td class="table_body" style="vertical-align: middle;"><?php echo number_format($row["real_pay_amount"],2);?></td>
						<td class="table_body" style="vertical-align: middle;text-align:center;">
							<?php
								foreach($row["receipt_id"] as $index => $receipt_id) {
									echo $index >= 1 ? ", ".$receipt_id : $receipt_id;
								}
							?>
						</td>
						<td class="table_body" style="vertical-align: middle;"><?php echo number_format($row["pay_amount"] - $row["real_pay_amount"],2);?></td>
					</tr>
				<?php
					}
				?>
					<tr>
						...
						<td class="table_body" style="vertical-align: middle;"><?php echo number_format($paid_total,2);?></td>
						<td class="table_body" style="vertical-align: middle;"></td>
						<td class="table_body" style="vertical-align: middle;"><?php echo number_format($debt_total,2);?></td>
					</tr>
				</tbody>
			</table>
		</body>
