		...
		?>	
			<tr>
				...
				<td class="text-center">
					...
					<h3 class="title_view">รายงานรายการเรียกเก็บล่วงหน้า</h3>
				...
				<td style="width:100px;vertical-align: top;" class="text-right">
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_cremation_data/coop_report_advance_finance_month_excel'.$get_param); ?>">
