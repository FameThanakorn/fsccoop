		...
		?>	
			<tr>
				...
				<td class="text-center">
					...
					<h3 class="title_view">รายงานสมาชิกลาออก</h3>
					<h3 class="title_view">
					<?php
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_cremation_data/coop_report_resign_excel'.$get_param); ?>">
		...
		<table class="table table-view table-center">
			<thead>
				...
				<tr>
					...
					<th style="vertical-align: middle;">เหตุผลการลาออก</th>
			...
			?>
				<tr>
					...
					<td class="text-center" style="vertical-align: middle;"><?php echo $this->center_function->ConvertToThaiDate($row["created_at"]);?></td>
					<td class="text-center" style="vertical-align: middle;"><?php echo $this->center_function->ConvertToThaiDate($row["approved_date"]);?></td>
					...
					<td class="text-center" style="vertical-align: middle;"><?php echo $row["reason"];?></td>
					<td class="text-center" style="vertical-align: middle;"><?php echo $row["bank_account_no"];?></td>
				</tr>
			<?php
			...
			?>
				<tr>
					<td colspan="7" class="text-center" style="vertical-align: middle;">รวม</td>
