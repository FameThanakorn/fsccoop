								...
								<div class="tab-pane fade" id="tab1">
									...
									<div class="g24-col-sm-24 m-t-1 hidden_table" id="">
										<div class="bs-example" data-example-id="striped-table">
											...
											<?php
											$share_type = array('SPM'=>'เก็บรายเดือน', 'SPA'=>'ซื้อพิเศษ', 'SPL'=>'ซื้อจากการกู้', 'SRP'=>'ถอนหุ้น', 'REVD'=>'คืนเงิน','SPD'=>'ส่วนต่างเก็บรายเดือนไม่ครบ','SDP'=>'ชำระหนี้คงค้าง');
											$run_no_share = 0;
											...
											<table class="table table-bordered table-striped table-center">
												...
												?>
													<tr> 
														...
														<td>
															<a href="<?php echo base_url(PROJECTPATH.'/admin/receipt_form_pdf/'.@$row_finance_detail['receipt_id']); ?>" target="_blank"><?php echo @$row_finance_detail['receipt_id'];?></a>
														</td>
														<td><?php echo (@$row_finance_detail['receipt_id'] != '' && @$row_finance_detail['receipt_status'] != '2')?'ชำระแล้ว':'ยังไม่ได้ชำระ'; ?></td>
														<td>
