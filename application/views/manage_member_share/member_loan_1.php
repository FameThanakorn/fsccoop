											...
											<table class="table table-bordered table-striped table-center">
												...
												?>
													<tr> 
														...
														<td>
															<?php 
																//echo (@$row_finance_detail['receipt_status'] == '1' && @$row_finance_detail['receipt_status'] != '2')?'ชำระแล้ว':'ยังไม่ได้ชำระ'; 
																if(@$row_finance_detail['non_pay_status'] == '2'){
																	if(!empty($is_resign)) {
																		echo 'ชำระแล้ว(ออกจากสมาชิก)';
																	} else {
																		echo 'ชำระแล้ว';
																	}
																} elseif($row_finance_detail['non_pay_status'] == '6') {
																	echo 'ชำระแล้ว(ออกจากสมาชิก)';
																} elseif($row_finance_detail['non_pay_status'] == '1') {
																	echo 'ยกเลิก';
																}else{
