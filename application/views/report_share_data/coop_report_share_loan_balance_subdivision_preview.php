				...
				<table class="table table-view table-center">
					<thead> 
						<tr>
							...
							<th rowspan="2" style="width:90px;vertical-align: middle;">รวมทุนเรือน <br>หุ้น(หน่วยงานรอง)</th> 
							<th rowspan="2" style="width: 90px;vertical-align: middle;">รวมเงินกู้<br>(หน่วยงานรอง)</th> 
						</tr> 
						<tr>
					...
					<?php
						...
						if(!empty($data_row)){
							foreach(@$data_row as $key => $row){								
								...
								$total_share_balance_subdivision += @$row['share_balance_subdivision'];
								$total_loan_balance_subdivision += @$row['loan_balance_subdivision'];
					?>					
							<tr> 
							  <td style="text-align: center;vertical-align: top;"><?php echo @$row['mem_group_id'];?></td>
							  <td style="text-align: left;vertical-align: top;"><?php echo @$row['mem_group_name']." :: ".@$row['mem_group_name_main'];?></td>				 
							  ...
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_emergent_person'],0); ?></td> 					 
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_emergent_balance'],2); ?></td> 					 
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_normal_person'],0); ?></td> 					 
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_normal_balance'],2); ?></td> 					 
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_special_person'],0); ?></td> 					 
							  ...
							  <td style="text-align: right;vertical-align: top;"><?php echo (@$arr_run_sub[@$row['mem_group_id_sub']] == @$row['run_sub'] && @$row['share_balance_subdivision'] != '0')?number_format(@$row['share_balance_subdivision'],2):''; ?></td>				 
							  <td style="text-align: right;vertical-align: top;"><?php echo (@$arr_run_sub[@$row['mem_group_id_sub']] == @$row['run_sub'] && @$row['loan_balance_subdivision'] != '0')?number_format(@$row['loan_balance_subdivision'],2):''; ?></td> 					 
							</tr>										
					...
					?>
						<tr> 
						  ...
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_emergent_person,0); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_emergent_balance,2); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_normal_person,0); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_normal_balance,2); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_special_person,0); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_special_balance,2); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_total_loan_balance,2); ?></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"></td> 					 
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"></td> 					 
						</tr>
					<?php
						}
