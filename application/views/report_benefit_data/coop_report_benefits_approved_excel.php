...
header("Content-Disposition: attachment; filename=รายงานอนุมัติสวัสดิการ.xls"); 
	...
	?>
				<table class="table table-bordered">
					<tr>
						...
						<tr>
							<th class="table_title" colspan="5">รายงานอนุมัติสวัสดิการ<?php echo $type_name;?></th>
						</tr>
						<tr>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="table_header_top" style="vertical-align: middle;">ชื่อสวัสดิการ</th>
					...
					?>
						<tr>
							...
							<td class="table_body" style="vertical-align: middle;"><?php echo $row["benefits_name"];?></td>
							<td class="table_body" style="vertical-align: middle;mso-number-format:'@';"><?php echo $row["member_id"];?></td>
							<td class="table_body" style="vertical-align: middle;"><?php echo $row["prename_full"].$row["firstname_th"]." ".$row["lastname_th"];?></td>
							<td class="table_body" style="vertical-align: middle;"><?php echo number_format($row["benefits_approved_amount"],2);?></td>
						</tr>
					<?php
						...
						?>
						<tr>
							<td colspan="4" class="table_body" style="vertical-align: middle;text-align: center;">รวม</td>
							<td class="table_body" style="vertical-align: middle;"><?php echo number_format($total,2);?></td>
						</tr>
					</tbody>
				</table>
		</body>
