...
<div style="width: 1000px;" class="page-break">
	<div class="panel panel-body" style="padding-top:10px !important;min-height: 1200px;">
		...
		?>	
			<tr>
				...
				<td class="text-center">
					...
					<h3 class="title_view">รายงานอนุมัติสวัสดิการ</h3>
					<h3 class="title_view">
					<?php
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_benefits_data/coop_report_benefits_approved_excel'.$get_param); ?>">
		...
		<table class="table table-view-2 table-center">
			...
			?>
				<tr>
					<td colspan="4" class="text-center" style="vertical-align: middle;">รวม</td>
					<td class="text-right" style="vertical-align: middle;"><?php echo number_format($total,2);?></td>
				</tr>
			<?php
				}
			?>
