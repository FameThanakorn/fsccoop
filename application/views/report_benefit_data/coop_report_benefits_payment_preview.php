		...
		?>	
			<tr>
				...
				<td class="text-center">
					...
					<h3 class="title_view">รายงานจ่ายสวัสดิการ</h3>
					<h3 class="title_view">
					<?php
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_benefits_data/coop_report_benefits_payment_excel'.$get_param); ?>">
