			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="table_body_right"><?php echo number_format(@$value['loan_deduct']['deduct_share'],2); ?></td>
							<td class="table_body_right"><?php echo number_format(@$value['loan_deduct']['deduct_blue_deposit'],2); ?></td>
							<td class="table_body_right"><?php echo number_format(@$value['loan_deduct']['deduct_insurance'],2); ?></td>
							<td class="table_body_right"><?php echo number_format(@$value['loan_deduct']['deduct_loan_other_buy'],2); ?></td>
							<td class="table_body_right"><?php echo number_format(@$value['loan_deduct']['deduct_person_guarantee'],2); ?></td>
							<td class="table_body_right"><?php echo number_format(@$value['loan_deduct']['deduct_loan_fee'],2); ?></td>
							<td class="table_body_right"><?php echo number_format(@$value['financial_institutions_amount'],2); ?></td>
							<td class="table_body_right"><?php echo number_format((@$value['loan_amount']-@$value['estimate_receive_money']),2); ?></td>
						...
						<?php if(count(@$value['prev_loan'],0) > 1){
				...
				<tfoot>
					<tr>
						...
						<td class="table_body_right"><?php echo number_format(@$deduct_loan_other_buy,2); ?></td>
