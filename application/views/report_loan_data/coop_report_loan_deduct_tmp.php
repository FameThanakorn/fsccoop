					...
					<table style="width: 95%;" border=0>
						<tr>
							<td class="normal_text text-center" colspan="2">
								ชื่อสมาชิก <?php echo @$member_data['prename_short'].@$member_data['firstname_th']." ".@$member_data['lastname_th']; ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="normal_text text-center">
								<?php echo @$_GET['deduct_pay_prev_loan'];?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="normal_text border-bottom text-center">
								<?php echo @$loan_deduct[$value['loan_deduct_list_code']]!=''?$loan_deduct[$value['loan_deduct_list_code']]:'-';?>
							</td>
						</tr>
						<?php } ?>
						<tr>
						...
						<tr>
							...
							<td class="normal_text border-bottom text-center">
								<?php echo @$_GET['pay_per_month']!=''?$_GET['pay_per_month']:'-'; ?>
							</td>
						</tr>
						<tr>
							<td class="normal_text">
						...
						<tr>
							...
							<td class="normal_text border-bottom text-center">
								<?php echo @$_GET['estimate_receive_money']; ?>
							</td>
						</tr>
						<tr>
							<td class="normal_text">
							...
							<td class="normal_text border-bottom text-center">
								<?php echo @$this->center_function->ConvertToThaiDate($this->center_function->ConvertToSQLDate($_GET['date_receive_money'])); ?>
							</td>
						</tr>
						<tr>
							<td class="normal_text">
							...
							<td class="normal_text border-bottom text-center">
								<?php 
								@$date_period = explode(' ',$this->center_function->ConvertToThaiDate($this->center_function->ConvertToSQLDate($_GET['date_first_period_label'])));
						...
						<tr>
							...
							<td class="normal_text border-bottom text-center">
								<?php echo @$_GET['event_guarantee']!=''?$_GET['event_guarantee']:'-'; ?>
							</td>
						</tr>
						<tr height="300px">
							...
							<span class="normal_text" style="float:left">(</span>
								<?php echo @$member_data['prename_short'].@$member_data['firstname_th']." ".@$member_data['lastname_th']; ?>
