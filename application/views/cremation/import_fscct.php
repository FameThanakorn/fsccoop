<div class="layout-content">
    <div class="layout-content-body">
		...
		<h1 style="margin-bottom: 0">นำเข้าฌาปนกิจ ชสอ.</h1>
                    ...
                    <table class="table table-bordered table-striped table-center">
                        ...
                        ?>
                            ...
                            <td class="text-center">
                                ...
                                <td class="text-center"><?php echo number_format($data["import_amount_balance"], 2); ?></td>
                            </tr>
                        <?php
                                }
                            } else {
    ...
    <div class="modal-dialog modal-dialog-info">
        <div class="modal-content">
            <div class="modal-header modal-header-info">
                <h2 class="modal-title">นำเข้าฌาปนกิจ ชสอ.</h2>
            </div>
            <div class="modal-body" style="height: 200px;">
                <div class="g24-col-xs-24 g24-col-sm-24 g24-col-md-24 g24-col-lg-24 padding-l-r-0">
                    ...
                    <label class="g24-col-xs-22 g24-col-sm-22 g24-col-md-22 g24-col-lg-22 padding-l-r-2 control-label text-left">
                        1.ทำการจัดรูปแบบ Excel ดังนี้ <a href="<?php echo base_url(PROJECTPATH."/cremation/download_file?type=fscct");?>"><span>ดาวน์โหลด Excel ตัวอย่าง</span></a>
                    </label>
	        	</div>
...
<script>
    $(document).ready(function(){
        ...
        //     window.location.href = base_url+"cremation/import_fscct?year=" + $(this).val();
        // });
