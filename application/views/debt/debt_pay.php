				...
				<form data-toggle="validator" method="post" action="<?php echo base_url(PROJECTPATH.'/debt/save_debt_pay'); ?>" class="g24 form form-horizontal" enctype="multipart/form-data" autocomplete="off" id="from_view">
					...
					<div class="bs-example" data-example-id="striped-table">
						<div id="tb_wrap">
							...
							<div class="row">
								<div class="col-sm-10 col-sm-offset-1">
								<p><b>รูปแบบการชำระ</b></p>
									<div class="col-sm-offset-1 col-sm-4">
										<div class="radio">
											<label><input type="radio" name="pay_type" value="0" checked>เงินสด <i class="fa fa-money"></i></label>
										</div>
										<div class="radio">
											<label><input type="radio" name="pay_type" value="1">เงินโอน <i class="fa fa-credit-card"></i></label>
										</div>
									</div>
								</div>
							</div>
