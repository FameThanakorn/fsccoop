...
<?php } else { ?>
		...
		<div class="col-md-6 col-md-offset-3">
				<h1 class="text-center m-t-1 m-b-2"> <?php echo(!empty($id)) ? "แก้ไขรายการชำระเงิน" : "เพิ่มรายการชำระอื่นๆ " ; ?></h1>

				<form id='form_save' data-toggle="validator" novalidate="novalidate" action="<?php echo base_url(PROJECTPATH.'/setting_account_data2/coop_account_receipt_save'); ?>" method="post">	
			<?php if (!empty($id)) { ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input id="account_list" name="account_list" class="form-control m-b-1" type="text" value="<?php echo @$row['account_list']; ?>" required>
				</div>

				<label class="col-sm-3 control-label" for="form-control-2">จำนวนเงิน</label>
				<div class="col-sm-9">
					<input id="amount" name="amount" class="form-control m-b-1" type="number" value="<?php echo @$row['amount']; ?>" required>
				</div>
			</div>
...
<?php
$link = array(
    'src' => PROJECTJSPATH.'assets/js/coop_account_receipt.js',
