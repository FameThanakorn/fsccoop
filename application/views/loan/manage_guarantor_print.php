...
td.guarantor_table > table > tbody > tr > td:nth-child(1), td.guarantor_table > table > tbody > tr > td:nth-child(3){
    text-align: center;
}
				...
				?>	
					<tr>
						...
						<td class="text-center">
							...
							<h3 class="title_view">รายงานการเปลี่ยนแปลงผู้ค้ำประกัน <?php echo $type_name;?></h3>
                        ...
                        foreach ($guarantor_history as $key => $value) {
                            ...
                            <table width='100%'>
                                <thead>
                                    ...
                                    <tr>
                                        <td width="50%">
                                            <h3><b>ผู้ค้ำประกันเดิม</b></h3>
                                        </td>
                                        <td>
                                            <h3><b>ผู้ค้ำประกันใหม่</b></h3>
                                        </td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td width="50%" style="vertical-align: text-top;" class="guarantor_table">
                                            <?php
                                                $fn_table->set_template($template);
                                                $fn_table->set_heading('เลขที่สมาชิก', 'ชื่อสกุล', 'วงเงินค้ำประกัน');
                                                $data = $value->guarantor_previous;
