				...
				?>	
					<tr>
						...
						<td class="text-center">
							...
							<h3 class="title_view">รายงานพัสดุเปรียบเทียบ</h3>
						 ...
						 <td style="width:100px;vertical-align: top;" class="text-right">
							...
							?>
							<a class="no_print" target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_facility/compare_excel'.$get_param); ?>">
				...
				<table class="table table-view table-center">
					<thead> 
						<tr>
							...
							<th style="vertical-align: middle;">ปี</th>
					...
					?>
							<tr> 
							  ...
							  <td style="text-align: center;vertical-align: top;"><?php echo $row['year1'];?></td>
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format($row['qty1']);?></td>
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format($row['store_price1'],2);?></td>
							  <td style="text-align: center;vertical-align: top;"><?php echo $row['year2'];?></td>
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format($row['qty2']);?></td>
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format($row['store_price2'],2);?></td>
							</tr>										
					...
					<?php if(@$page == @$page_all){ ?>
						<tr style="font-weight: bold;">
							...
							<td style="text-align: right;vertical-align: top;"><?php echo number_format($totals['qty1']); ?></td>
							<td style="text-align: right;vertical-align: top;"><?php echo number_format($totals['store_price1'], 2); ?></td>
							<td style="text-align: right;vertical-align: top;"></td>
							<td style="text-align: right;vertical-align: top;"><?php echo number_format($totals['qty2']); ?></td>
							<td style="text-align: right;vertical-align: top;"><?php echo number_format($totals['store_price2'], 2); ?></td>
						</tr>
					<?php } ?>
					</tbody>
				</table>
