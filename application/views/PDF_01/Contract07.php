        ...
        $pdf->AddPage();
            ...
            if($pageNo == '1'){
                ...
                $y_point = 30;
                    ...
                    $pdf->MultiCell(13, 5, U2T(''), $border, "C"); // หนังสือกู้ที่
                ...
                $y_point = 38;
                    ...
                    $pdf->MultiCell(11, 5, U2T($month_short_arr[$date_to_month]), $border, "C"); // วันที่(เดือน)
                    $pdf->SetXY(180, $y_point, 3);
                    $pdf->MultiCell(11, 5, U2T($date_to_year), $border, "C"); // วันที่(ปี)
                $y_point = 51.5;
                    $pdf->SetXY(131, $y_point, 3);
                    $pdf->MultiCell(63.8, 5, U2T($data['coop_profile']['coop_name_th']), $border, "C"); // เขียนที่
                $y_point = 59.2;
                ...
                $y_point = 101.8;
                    ...
                    $pdf->MultiCell(70, 5, U2T($data['loan_reason']), $border, "C"); // เหตุผลกู้
                $y_point = 109.5;
                    $pdf->SetXY(115, $y_point, 3);
                    $pdf->MultiCell(75, 5, U2T($data['position_name']), $border, "C"); // ตำแหน่ง
                $y_point = 117;
                    $pdf->SetXY(105, $y_point, 3);
                    $pdf->MultiCell(39, 5, U2T($data['id_card']), $border, "C"); // ชื่อ
                    $pdf->SetXY(153, $y_point, 3);
                    $pdf->MultiCell(39, 5, U2T(($data['mem_group_name_level']=='')?'-':$data['mem_group_name_level']), $border, "C"); // ชื่อ
                $y_point = 124.9;
                    $pdf->SetXY(54.5, $y_point, 3);
                    $pdf->MultiCell(26, 5, U2T($data['c_address_no']), $border, "C"); // ชื่อ
                    $pdf->SetXY(90, $y_point, 3);
                    $pdf->MultiCell(37, 5, U2T(($data['c_address_road']=='')?'-':$data['c_address_road']), $border, "C"); // ชื่อ
                    $pdf->SetXY(138, $y_point, 3);
                    $pdf->MultiCell(53, 5, U2T(($data['c_district_name']=='')?'-':$data['c_district_name']), $border, "C"); // ชื่อ
                $y_point = 132.4;
                    $pdf->SetXY(30.5, $y_point, 3);
                    $pdf->MultiCell(45, 5, U2T($data['c_amphur_name']), $border, "C"); // ชื่อ
                    $pdf->SetXY(90, $y_point, 3);
                    $pdf->MultiCell(37, 5, U2T($data['c_province_name']), $border, "C"); // ชื่อ
                ...
                if($data['pay_type']==1){
                    ...
                    $pdf->MultiCell(35, 5, U2T($data['money_per_period']), $border, "C"); //อำเภอ, เขต
                    $pdf->SetXY( 164, $y_point );
                    $pdf->MultiCell(18, 5, U2T($data['period_amount']), $border, "C"); //อำเภอ, เขต
                }
                if($data['pay_type']==2){
                    $y_point = 208.9;
                    $pdf->Image($myImage, 42.2, $y_point, 3);
                    ...
                    $pdf->MultiCell(40, 5, U2T($data['money_per_period']), $border, "C"); //อำเภอ, เขต
                    $pdf->SetXY( 164, $y_point );
                    $pdf->MultiCell(18, 5, U2T($data['period_amount']), $border, "C"); //อำเภอ, เขต
                }
            }else if($pageNo == '4'){
                ...
                $y_point = 125;
                    ...
                    $pdf->MultiCell(63, 5, U2T($data['loan_amount']), $border, "C"); //อำเภอ, เขต 
  
                 $y_point = 171.3;
                    $pdf->SetXY(64.2, $y_point);
                    $pdf->MultiCell(130, 5, U2T(''), $border, "C"); //อำเภอ, เขต 
                $y_point = 178.8;
                ...
                $y_point = 39.5;
                    ...
                    $pdf->MultiCell(17, 5, U2T(''), $border, "C"); //ที่
                ...
                $y_point = 85.5;
                    ...
                    $pdf->MultiCell(42, 5, U2T($data['mem_group_name_level']), $border, "C"); //ที่
                    $pdf->SetXY(170, $y_point);
                    $pdf->MultiCell(20, 5, U2T($data['c_address_no']), $border, "C"); //ที่
                $y_point = 93.2;
                    $pdf->SetXY(27.5, $y_point);
                    $pdf->MultiCell(35, 5, U2T(($data['c_address_road']=='')?'-':$data['address_road']), $border, "C"); //ที่
                    $pdf->SetXY(70, $y_point);
                    $pdf->MultiCell(30, 5, U2T(($data['c_district_name']=='')?'-':$data['district_name']), $border, "C"); //ที่
                    $pdf->SetXY(114, $y_point);
                    $pdf->MultiCell(35, 5, U2T($data['c_amphur_name']), $border, "C"); //ที่
                    $pdf->SetXY(160, $y_point);
                    $pdf->MultiCell(33, 5, U2T($data['c_province_name']), $border, "C"); //ที่
                $y_point = 100.9;
                    $pdf->SetXY(35.5, $y_point);
                ...
                if($data['pay_type']==1){
                    ...
                    $y_point = 139;
                    $pdf->SetXY(104, $y_point);
                    $pdf->MultiCell(63, 5, U2T($data['money_per_period']), $border, "C"); //ที่
                }else if($data['pay_type']==2){
                    $y_point = 148;
                    $pdf->Image($myImage, 41.9, $y_point, 3);
                    $y_point = 146.9;
                    $pdf->SetXY(122, $y_point);
                    $pdf->MultiCell(64, 5, U2T($this->center_function->numbetText($data['money_per_period'])), $border, "C"); //ที่
                    $y_point = 154.8;
                    $pdf->SetXY(48, $y_point);
                    $pdf->MultiCell(30, 5, U2T($this->center_function->numbetText($data['period_amount'])), $border, "C"); //ที่
                    $pdf->SetXY(152.5, $y_point);
                    $pdf->MultiCell(34, 5, U2T($this->center_function->numbetText($data['interest_per_year'])), $border, "C"); //ที่
                    $y_point = 162.5;
                    $pdf->SetXY(59, $y_point);
                    $pdf->MultiCell(31, 5, U2T($this->center_function->numbetText($month_arr['$month_start'])), $border, "C"); //ที่
                }
            }else if ($pageNo == '6'){
                // $y_point = 112.7;
                ...
                $y_point = 227;
                    ...
                    $pdf->MultiCell(80, 5, U2T($fullname_th), $border, "C"); //ที่
                    $pdf->SetXY(149, $y_point);
                    $pdf->MultiCell(38, 5, U2T($data['loan_amount']), $border, "C"); //ที่
                $y_point = 234.5;
                    $pdf->SetXY(21, $y_point);
                    $pdf->MultiCell(80, 5, U2T($this->center_function->convert($data['loan_amount'])), $border, "C"); //ท
            }else if($pageNo == '7'){
                ...
                $pdf->SetXY(134.5, $y_point);
                 $pdf->MultiCell(60, 5, U2T($data['coop_profile']['coop_name_th']), $border, "C"); //
                $y_point = 54.4;
                $pdf->SetXY(120, $y_point);
                $pdf->MultiCell(15, 5, U2T($date_to_text), $border, "C"); //
                $pdf->SetXY(142.5, $y_point);
                $pdf->MultiCell(28, 5, U2T($month_arr[$date_to_month]), $border, "C"); //
                $pdf->SetXY(176.5, $y_point);
                $pdf->MultiCell(23, 5, U2T($date_to_year), $border, "C"); //
                $y_point = 61.8;
                $pdf->SetXY( 43.5, $y_point );
                $pdf->MultiCell(58, 5, U2T($fullname_th), $border, "C"); //ชื่อs...
                $pdf->SetXY( 135.5, $y_point );
                $pdf->MultiCell(40, 5, U2T($data['id_card']), $border, "C"); //
                ...
                $pdf->MultiCell(44, 5, U2T($data['c_district_name']), $border, "C"); //
                $pdf->SetXY( 98, $y_point );
                $pdf->MultiCell(36, 5, U2T($data['c_amphur_name']), $border, "C"); //
                $pdf->SetXY( 152, $y_point );
                $pdf->MultiCell(40, 5, U2T($data['c_province_name']), $border, "C"); //
                $y_point = 84.8;
                $pdf->SetXY( 47, $y_point );
                $pdf->MultiCell(35, 5, U2T($data['tel']), $border, "C"); //
                ...
                $pdf->MultiCell(35, 5, U2T($data['mem_group_full_name_level']), $border, "C"); //
                $pdf->SetXY( 102, $y_point );
                $pdf->MultiCell(20, 5, U2T($data['salary']), $border, "C"); //
                $pdf->SetXY( 131.5, $y_point );
                $pdf->MultiCell(60, 5, U2T($this->center_function->convert($data['salary'])), $border, "C"); //s
            }else if($pageNo == '12'){   
                $y = 7.6; 
                $y_point = 76;
                $pdf->SetXY( 127, $y_point );
                $pdf->MultiCell(10, 5, U2T($date_to_text), $border, "C"); //
                $pdf->SetXY( 145, $y_point );
                $pdf->MultiCell(30, 5, U2T($month_arr[$date_to_month]), $border, "C"); //
                $pdf->SetXY( 181, $y_point );
                $pdf->MultiCell(15, 5, U2T($date_to_year), $border, "C"); //
                $y_point = 92;
                $pdf->SetXY( 45, $y_point );
                $pdf->MultiCell(100, 5, U2T($data['marry_name']), $border, "C"); //
                $pdf->SetXY( 158, $y_point );
                // $pdf->MultiCell(25, 5, U2T($age), $border, "C"); //
                $y_point += $y;
                $pdf->SetXY( 40, $y_point );
                $pdf->MultiCell(23, 5, U2T($data['m_address_no']), $border, "C"); //
                $pdf->SetXY( 72, $y_point );
                $pdf->MultiCell(15, 5, U2T($data['m_address_moo']), $border, "C"); //
                $pdf->SetXY( 105, $y_point );
                $pdf->MultiCell(35, 5, U2T($data['m_address_soi']), $border, "C"); //
                $pdf->SetXY( 150, $y_point );
                $pdf->MultiCell(40, 5, U2T($data['m_address_road']), $border, "C"); //
                $y_point += $y;
                $pdf->SetXY( 40, $y_point );
                $pdf->MultiCell(47, 5, U2T($data['m_district_name']), $border, "C"); //
                $pdf->SetXY( 105, $y_point );
                $pdf->MultiCell(35, 5, U2T($data['m_amphur_name']), $border, "C"); //
                $pdf->SetXY( 153, $y_point );
                $pdf->MultiCell(37, 5, U2T($data['m_province_name']), $border, "C"); //
                $y_point += $y;
                $pdf->SetXY( 55, $y_point );
                $pdf->MultiCell(100, 5, U2T($fullname_th), $border, "C"); //

                $y_point = 215;
                $pdf->SetXY( 50, $y_point );
                $pdf->MultiCell(110, 5, U2T($fullname_th), $border, "C"); //
                $y_point += $y;
                $pdf->SetXY( 50, $y_point );
                $pdf->MultiCell(95, 5, U2T($data['marry_name']), $border, "C"); //
