        ...
        $pdf->AddPage();
            ...
            if($pageNo == '1'){
                ...
                $y_point = 77;
                    ...
                    $pdf->MultiCell(35, 5, U2T($data['member_card']), $border, "C"); //สมาชิกเลขทะเบียนที่
                ...
                $y_point = 84.8;
                    ...
                    $pdf->MultiCell(16, 5, U2T(($data['c_address_moo']=='')?'-':$data['c_address_moo']), $border, "C"); //หมู่
                    $pdf->SetXY( 119, $y_point );
                    $pdf->MultiCell(30, 5, U2T(($data['c_address_soi']=='')?'-':$data['c_address_soi']), $border, "C"); //ซอย
                    $pdf->SetXY( 158.5, $y_point );
                    $pdf->MultiCell(37, 5, U2T(($data['c_address_road']=='')?'-':$data['c_address_road']), $border, "C"); //ถนน
                $y_point = 92.6;
                ...
                $y_point = 103.6;
                    ...
                    $pdf->MultiCell(15.7, 5, U2T(($data['m_address_moo']=='')?'-':$data['m_address_moo']), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 109.7, $y_point );
                    $pdf->MultiCell(36, 5, U2T(($data['m_address_soi']=='')?'-':$data['m_address_soi']), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 155.5, $y_point );
                    $pdf->MultiCell(40, 5, U2T(($data['m_address_road']=='')?'-':$data['m_address_road']), $border, "C"); //ชื่อผู้กู้
                $y_point = 111;
                    $pdf->SetXY( 45.2, $y_point );
