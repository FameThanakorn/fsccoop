        ...
        $pdf->AddPage();
            ...
            if($pageNo == '1'){
                ...
                $y_point = 93.9;
                    ...
                    $pdf->MultiCell(29.5, 5, U2T($data['mem_group_name_level']), $border, "C"); //สมาชิกเลขทะเบียนที่
                ...
                $y_point = 101.3;
                    ...
                    $pdf->MultiCell(25, 5, U2T($data['salary']-$data['money_per_period']), $border, "C"); //สมาชิกเลขทะเบียนที่
                $y_point = 109.1;
                    $pdf->SetXY( 31.5, $y_point );
                    $pdf->MultiCell(15, 5, U2T($month_short_arr[$date_to_month]), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 54, $y_point );
                    $pdf->MultiCell(25, 5, U2T($date_to_year), $border, "C"); //ชื่อผู้กู้
                $y_point = 116.1;
                    $pdf->SetXY( 157.5, $y_point );
                    $pdf->MultiCell(30, 5, U2T($data['loan_amount']), $border, "C"); //ชื่อผู้กู้
                $y_point = 123.7;
                    $pdf->SetXY( 23, $y_point );
                    $pdf->MultiCell(50, 5, U2T($money_loan_amount_2text), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 95, $y_point );
                    $pdf->MultiCell(90, 5, U2T($data['loan_reason']), $border, "C"); //ชื่อผู้กู้
                // $y_point = 165.9;
                ...
                $y_point = 87;
                    ...
                    $pdf->MultiCell(34, 5, U2T($full_date), $border, "C"); //ชื่อผู้กู้
                $y_point = 94.5;
                    $pdf->SetXY( 44, $y_point );
                    $pdf->MultiCell(150, 5, U2T($fullname_th), $border, "C"); //ชื่อผู้กู้
                $y_point = 101.8;
                    $pdf->SetXY( 48, $y_point );
                    $pdf->MultiCell(148, 5, U2T($fullname_th), $border, "C"); //ชื่อผู้กู้
                $y_point = 109.2;
                    $pdf->SetXY( 155.5, $y_point );
                    $pdf->MultiCell(34, 5, U2T($data['member_id']), $border, "C"); //ชื่อผู้กู้
                $y_point = 116.7;
                    $pdf->SetXY( 80, $y_point );
                    $pdf->MultiCell(60, 5, U2T($data['position']), $border, "C"); //ชื่อผู้กู้
                // $y_point = 124.2;
                //     $pdf->SetXY( 47, $y_point );
