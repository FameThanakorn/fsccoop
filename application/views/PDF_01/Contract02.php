        ...
        $pdf->AddPage();
            ...
            if($pageNo == '1'){
                ...
                $y_point = 48.1;
                    ...
                    $pdf->MultiCell(61, 5, U2T($data['coop_profile']['coop_name_th']), $border, "C"); //เขียนที่
                $y_point = 55;
                ...
                $y_point = 81.2;
                    ...
                    $pdf->MultiCell(50, 5, U2T($data['mem_group_name_level']), $border, "C"); //สังกัด
                $y_point = 95.8;
                ...
                $y_point = 215;
                    ...
                    $pdf->MultiCell(30, 5, U2T($data['mem_group_name_faction']), $border, "C"); //แผนก
                    $pdf->SetXY( 130.7, $y_point );
                    $pdf->MultiCell(27, 5, U2T($data['mobile']), $border, "C"); //เบอร์โทรศัพท์
                    $pdf->SetXY( 175, $y_point );
                    $pdf->MultiCell(16, 5, U2T($age), $border, "C"); //อายุ
                $y_point = 222.3;
                    ...
                    $pdf->MultiCell(28, 5, U2T($data['other_income']), $border, "C"); //แผนก
                    if ($data["marry_status"] == 1){
                        $y_point = 231;
                        $pdf->Image($myImage, 67.5, $y_point, 3);
                    }else if ($data["marry_status"] == 2){
                        $y_point = 231;
                        $pdf->Image($myImage, 81.5, $y_point, 3);
                    }
                $y_point = 236.5;
                ...
                $y_point = 258.1;
                    ...
                    $pdf->MultiCell(22, 5, U2T($data['m_address_no']), $border, "C"); //อายุ
                    $pdf->SetXY( 117.2, $y_point );
                    $pdf->MultiCell(28.5, 5, U2T($data['m_address_moo']), $border, "C"); //อายุ
                    $pdf->SetXY( 153.2, $y_point );
                    $pdf->MultiCell(42, 5, U2T($data['m_address_soi']), $border, "C"); //อายุ
                $y_point = 265.1;
                    $pdf->SetXY( 32.5, $y_point );
                    $pdf->MultiCell(38.5, 5, U2T($data['m_address_road']), $border, "C"); //อายุ
                    $pdf->SetXY( 88.7, $y_point );
                    $pdf->MultiCell(45, 5, U2T($data['m_district_name']), $border, "C"); //อายุ
                    $pdf->SetXY( 150, $y_point );
                    $pdf->MultiCell(45, 5, U2T($data['m_amphur_name']), $border, "C"); //อายุ
                $y_point = 272.3;
                    $pdf->SetXY( 36, $y_point );
                    $pdf->MultiCell(49, 5, U2T($data['m_province_name']), $border, "C"); //อายุ
                    $pdf->SetXY( 107, $y_point );
                    $pdf->MultiCell(25, 5, U2T($data['m_district_code']), $border, "C"); //อายุ
                    $pdf->SetXY( 142, $y_point );
                    $pdf->MultiCell(55, 5, U2T($data['m_tel']), $border, "C"); //อายุ
            }else if($pageNo == '4'){
                $y_point = 93.1;
                    $pdf->SetXY( 43, $y_point );
                    $pdf->MultiCell(60.5, 5, U2T($fullname_th), $border, "C"); //ชื่อคู่สมรส
                    $pdf->SetXY( 127, $y_point );
                    // $pdf->MultiCell(60.5, 5, U2T('Interscope Records'), $border, "C"); //ชื่อคู่สมรส
                $y_point = 100.2;
                    $pdf->SetXY( 140, $y_point );
                    $pdf->MultiCell(56, 5, U2T($data['mobile']), $border, "C"); //ชื่อคู่สมรส
                ...
                $y_point = 79;
                    ...
                    $pdf->MultiCell(19, 5, U2T($data['c_address_no']), $border, "C"); //บ้านเลขที่
                    $pdf->SetXY( 85.5, $y_point );
                    $pdf->MultiCell(16, 5, U2T($data['c_address_moo']), $border, "C"); //หมู่
                    $pdf->SetXY( 119, $y_point );
                    $pdf->MultiCell(30, 5, U2T($data['c_address_soi']), $border, "C"); //ซอย
                    $pdf->SetXY( 158.5, $y_point );
                    $pdf->MultiCell(37, 5, U2T($data['c_address_road']), $border, "C"); //ถนน
                $y_point = 86.8;
                    $pdf->SetXY( 44, $y_point );
                    $pdf->MultiCell(30, 5, U2T($data['c_district_name']), $border, "C"); //ตำบล
                    $pdf->SetXY( 95, $y_point );
                    $pdf->MultiCell(46, 5, U2T($data['c_amphur_name']), $border, "C"); //อำเภอ
                    $pdf->SetXY( 153, $y_point );
                    $pdf->MultiCell(42.5, 5, U2T($data['c_province_name']), $border, "C"); //จังหวัด
                $y_point = 94.3;
                    $pdf->SetXY( 52, $y_point );
                ...
                $y_point = 101.8;
                    ...
                    $pdf->MultiCell(36, 5, U2T($data['mem_group_name_level']), $border, "C"); //สังกัต
                ...
                $y_point = 132.8;
                    ...
                    $pdf->MultiCell(31, 5, U2T($data['petition_number']), $border, "C"); //สัญญากู้เลขที่
                    $pdf->SetXY( 140.5, $y_point );
                    $pdf->MultiCell(31, 5, U2T($data['contract_number']), $border, "C"); //คำขอกู้เลขที่
            }else if($pageNo == '8'){
                ...
                $y_point = 80.1;
                    ...
                    $pdf->MultiCell(100, 5, U2T($data['marry_name']), $border, "C"); //ชื่อผู้กู้
                ...
                $y_point = 87.9;
                    ...
                    $pdf->SetXY( 76.5, $y_point );
                    $pdf->MultiCell(15.7, 5, U2T($data['m_address_moo']), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 109.7, $y_point );
                    $pdf->MultiCell(36, 5, U2T($data['m_address_soi']), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 155.5, $y_point );
                    $pdf->MultiCell(40, 5, U2T($data['m_address_road']), $border, "C"); //ชื่อผู้กู้
                $y_point = 95.1;
                    $pdf->SetXY( 45.2, $y_point );
                    $pdf->MultiCell(47, 5, U2T($data['m_district_name']), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 110, $y_point );
                    $pdf->MultiCell(35, 5, U2T($data['m_amphur_name']), $border, "C"); //ชื่อผู้กู้
                    $pdf->SetXY( 158, $y_point );
                    $pdf->MultiCell(35, 5, U2T($data['m_province_name']), $border, "C"); //ชื่อผู้กู้
                $y_point = 102.9;
