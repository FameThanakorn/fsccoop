                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach($row as $key => $value){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url(PROJECTPATH.'/loan_atm/show_loan_atm_detail/'.$value['loan_atm_id']); ?>" target="_blank">ดูรายละเอียด</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    ...
    function get_search_member(){
        $.ajax({
            type: "POST",
            url: base_url+'loan_atm/get_search_loan',
            data: {
