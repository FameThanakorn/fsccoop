			...
			<div class="row">
				<div  class="col-md-9 col-md-offset-1">
                   ...
                   <br>
					...
					<br>
					<br>
					<form class="form form-horizontal" action="<?php echo base_url(PROJECTPATH.'/api/atm_request'); ?>" method="post">
						<input name="_key" type="hidden" value="KJAUUMJZYRHL5TDX">
						<input name="_secret" type="hidden" value="srF4J^+cJ6e9YFV9tt#hrR^ufKENbCVh">
						<?php 
