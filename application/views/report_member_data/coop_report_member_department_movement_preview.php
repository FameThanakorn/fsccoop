		...
		?>	
			<tr>
				...
				<td class="text-center">
					...
					<h3 class="title_view">รายงานการย้ายหน่วย</h3>
					<h3 class="title_view">
					<?php
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/report_member_data/coop_report_member_department_movement_excel'.$get_param); ?>">
		...
		<table class="table table-view-2 table-center">
			<thead>
				...
				<tr>
					...
					<th style="width: 80px;vertical-align: middle;">เลขสมาชิก</th>
					<th style="width: 150px;vertical-align: middle;">ชื่อ-นามสกุล</th>
					<th style="width: 100px;vertical-align: middle;">วันที่ย้าย</th>
					<th style="width: 230px;vertical-align: middle;">หน่วยงานเดิม</th>
					<th style="width: 230px;vertical-align: middle;">หน่วยงานใหม่</th>
					<th style="width: 150px;vertical-align: middle;">ผู้ทำรายการ</th>
				</tr>
			</thead>
			<tbody>
			...
			?>
				<tr>
					...
					<td style="text-align: center;vertical-align: top;"><?php echo ($row['date_move'])?$this->center_function->ConvertToThaiDate($row['date_move'],1,0):"";?></td>
					<td style="text-align: left;vertical-align: top;"><?php echo $row["level_old_name"];?></td>
