...
header("Content-Disposition: attachment; filename=รายงานสมาชิกพ้นสภาพ.xls"); 
...
?>
			<table class="table table-bordered">	
				<tr>
					...
					<tr>
						<th class="table_title" colspan="11">รายงานสมาชิกพ้นสภาพ</th>
					</tr>
					<tr>
					...
					<tr>
						<th class="table_title_right" colspan="11">
			...
			<table class="table table-bordered">
				<thead> 
					<tr>
						...
						<th class="table_header_top" style="vertical-align: middle;">วันที่ให้ออก</th>
						...
						<th class="table_header_top" style="vertical-align: middle;">หนี้คงค้าง</th>
