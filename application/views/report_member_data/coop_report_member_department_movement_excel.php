...
header("Content-Disposition: attachment; filename=รายงานการย้ายหน่วย.xls"); 
	...
	<html>
		...
		<body>
			...
			<table class="table table-bordered">
				...
				<tr>
					<th class="table_title" colspan="7">รายงานการย้ายหน่วย<?php echo $type_name;?></th>
				</tr>
				<tr>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="table_header_top" style="vertical-align: middle;">วันที่ย้าย</th>
						<th class="table_header_top" style="vertical-align: middle;">หน่วยงานเดิม</th>
						<th class="table_header_top" style="vertical-align: middle;">หน่วยงานใหม่</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="table_body" style="text-align: center;vertical-align: top;"><?php echo ($row['date_move'])?$this->center_function->ConvertToThaiDate($row['date_move'],1,0):"";?></td>
						<td class="table_body" style="text-align: left;vertical-align: top;"><?php echo $row["level_old_name"];?></td>
						<td class="table_body" style="text-align: left;vertical-align: top;"><?php echo $row["level_name"];?></td>
						<td class="table_body" style="text-align: left;vertical-align: top;"><?php echo $row["user_name"];?></td>
					</tr>
					<?php
						}
					?>
