...
header("Content-Disposition: attachment; filename=รายงานสมาชิกให้ออก.xls"); 
...
?>
			<table class="table table-bordered">	
				<tr>
					...
					<tr>
						<th class="table_title" colspan="13">รายงานสมาชิกให้ออก</th>
					</tr>
					<tr>
					...
					<tr>
						<th class="table_title_right" colspan="13">
			...
			<table class="table table-bordered">
				...
				<?php
					...
					<tr>
						...
						?>
						<td class="table_body" style="text-align: center;"><?php echo $row['dividend_acc_num'];?></td>
					</tr>
					<?php
						}
					?>
					<tr>
						<td class="table_body" colspan="3" style="text-align: center;">
							<?php
								$text = "";
								if(!empty($male_count)) {
