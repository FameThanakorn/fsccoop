					...
					<tr>
						...
						<td class="text-center">
							<img src="<?php echo base_url(PROJECTPATH.'/assets/images/coop_profile/'.$_SESSION['COOP_IMG']); ?>" alt="Logo" style="height: 80px;" />	
							 ...
							 <h3 class="title_view">รายงานสมาชิกพ้นสภาพ</h3>
							 <h3 class="title_view">
								<?php 
						 ...
						 <td style="width:100px;vertical-align: top;" class="text-right">
							...
							?>
							<a class="no_print"  target="_blank" href="<?php echo base_url('/report_member_data/coop_report_member_relinquish_excel'.$get_param); ?>">
				...
				<table class="table table-view table-center">
					<thead> 
						<tr>
							...
							<th style="vertical-align: middle;">ดอกเบี้ยงคงค้าง</th>
							<th style="vertical-align: middle;">เงินฝาก</th>
							<th style="vertical-align: middle;">ดอกเบี้ยเงินฝาก</th>
							<th style="vertical-align: middle;">หนี้คงค้าง</th>
