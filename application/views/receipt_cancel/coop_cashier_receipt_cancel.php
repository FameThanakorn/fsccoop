...
<h1 class="title_top">ยกเลิกรายการชำระอื่นๆ</h1>
...
<form action="<?php echo base_url(PROJECTPATH.'/receipt_cancel/coop_cashier_receipt_cancel'); ?>" id="cancel_form" method="POST">
...
<script>
	function cancel(receipt_id){
        var title = 'ยกเลิกรายการชำระอื่นๆ';
        swal({
            title: title,
            text: "",
            type: "warning",
        ...
        function(isConfirm) {
            if (isConfirm) {
                // document.location.href = base_url+'/receipt_cancel/coop_cashier_receipt_cancel?receipt_id='+receipt_id;
    ...
    function check_search() {
		if ($('#search_list').val() == '') {
            ...
            document.location.href = base_url +'receipt_cancel/coop_cashier_receipt_cancel?search_text='+$('#search_text').val()+"&search_list="+$('#search_list').val();
		}
	}
